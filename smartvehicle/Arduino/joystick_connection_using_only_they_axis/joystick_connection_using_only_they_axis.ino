...
const int motorBEnablePin = 8;  // Connect to L298N ENA

// Ultrasonic sensor connections
const int trigPin = 4;  // Connect to the trigger pin on the ultrasonic sensor
const int echoPin = 5;  // Connect to the echo pin on the ultrasonic sensor
